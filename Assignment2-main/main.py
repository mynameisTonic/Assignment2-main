...
if down_payment_input >= 5  and down_payment_input < 10:
    insurance_cost = (purchase - down_payment_total) * insurance_rate1
    ...
    insurance_cost = (purchase - down_payment_total) * insurance_rate2
    principal_amount = purchase - down_payment_total + insurance_cost
    ...
    insurance_cost = (purchase - down_payment_total) * insurance_rate3
    principal_amount = purchase - down_payment_total + insurance_cost
